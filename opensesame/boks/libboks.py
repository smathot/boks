...
CMD_RESET = chr(1).encode()
CMD_IDENTIFY = chr(2).encode()
CMD_WAIT_PRESS = chr(3).encode()
CMD_WAIT_RELEASE = chr(4).encode()
CMD_WAIT_SLEEP = chr(5).encode()
CMD_BUTTON_STATE	= chr(6).encode()
CMD_SET_T1 = chr(7).encode()
CMD_SET_T2 = chr(8).encode()
CMD_SET_TIMEOUT = chr(9).encode()
CMD_SET_BUTTONS = chr(10).encode()
CMD_SET_CONTINUOUS = chr(11).encode()
CMD_GET_T1 = chr(12).encode()
CMD_GET_T2 = chr(13).encode()
CMD_GET_TD = chr(14).encode()
CMD_GET_TIME = chr(15).encode()
CMD_GET_TIMEOUT = chr(16).encode()
CMD_GET_BUTTONS = chr(17).encode()
CMD_LED_ON = chr(18).encode()
CMD_LED_OFF = chr(19).encode()
CMD_GET_BTNCNT = chr(20).encode()
CMD_GET_SID = chr(21).encode()
CMD_LINK_LED = chr(22).encode()
...
class libboks(object):
    ...
    def set_continuous(self, continuous=True):
        ...
        self.dev.write(chr(1 if continuous else 0).encode())
